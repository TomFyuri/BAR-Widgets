...
-- Zero-K classics now in BAR!
-- select shurikens, press attack, draw a circle over enemy units, watch all shurikens pick their own target
-- entire enemy batch of units are now stunned ready for pick up and reclaiming. :>
...
function GetAAUnitList(units)
	...
	for i=1, #units,1 do  --catalog AA and non-AA
        ...
        local exclusiveAA = (primaryWeapon_target["vtol"]) and
                  not (primaryWeapon_target["sink"] or primaryWeapon_target["surface"] or primaryWeapon_target["sub"])
